...
## ✨ Features
- **Triple-Pane Editor:** Dedicated sections for HTML, CSS, and JS.
- **Live Preview:** Instant updates via a sandboxed iframe.
- **Console Output:** Integrated log system to track JavaScript execution and errors.
- **Persistence:** Save your project as a JSON file and reload it later.
- **Keyboard Shortcuts:** `Ctrl + S` to save and `Ctrl + Enter` to run code.
